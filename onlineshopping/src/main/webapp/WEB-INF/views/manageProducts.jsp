		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"> <!-- product - nazwa obiektu zwracanego w ManagementController.java przez metode showManageProducts() - nastepuje to polaczenia kontrolera ManagementController.java z tym formularzem-->
